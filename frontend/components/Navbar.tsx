  ...
  return (
    <nav className="sticky top-0 z-[100] bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ── Mobile Search Row (Only visible on small mobile screens) ── */}
      ...
      {/* ── Mobile/Tablet Menu ── */}
      {menuOpen && (
        <div className="lg:hidden border-t border-gray-200 bg-white px-4 py-4 space-y-2 animate-in slide-in-from-top-4 duration-200 shadow-xl">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
